    ...
    public class MarketField : Field
    {
        ...
        public void PrintAllItems()
        {
            ...
            foreach (var item in this.items)
            {
                ...
                if (item is AttackItemDto)
                {
                    itemList.Append("0".PadRight(CellWidth, paddingChar));
                    itemList.Append(((AttackItemDto)item).Attack.ToString().PadRight(CellWidth, paddingChar));
                    itemList.Append("0".PadRight(CellWidth, paddingChar));
                }
                else if (item is DefenseItemDto)
                {
                    itemList.Append(((DefenseItemDto)item).Defence.ToString().PadRight(CellWidth, paddingChar));
                    itemList.Append("0".PadRight(CellWidth, paddingChar));
                    itemList.Append("0".PadRight(CellWidth, paddingChar));
                }
                else if (item is DefenceAttackDto)
                {
                    itemList.Append(((DefenceAttackDto)item).Defence.ToString().PadRight(CellWidth, paddingChar));
                    itemList.Append(((DefenceAttackDto)item).Attack.ToString().PadRight(CellWidth, paddingChar));
                    itemList.Append("0".PadRight(CellWidth, paddingChar));
                }
