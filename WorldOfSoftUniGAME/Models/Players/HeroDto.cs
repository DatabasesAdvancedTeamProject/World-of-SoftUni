﻿namespace WorldOfSoftuniRPG.Models.Players
 {
     ...
     public abstract class HeroDto : PlayerObject
     {
         ...
         protected HeroDto(int attack, int defence, int health)
         ...
         {
             if (item is DefenseItemDto)
             {
                 this.Defence += ((DefenseItemDto)item).Defence;
             }
             else if (item is AttackItemDto)
             {
                 this.Attack += ((AttackItemDto)item).Attack;
             }
             else if (item is DefenceAttackDto)
             {
                 this.Attack += ((DefenceAttackDto)item).Attack;
                 this.Defence += ((DefenceAttackDto)item).Defence;
             }
         }
